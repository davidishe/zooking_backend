...
namespace SendpulseAPI
{
    public class Sendpulse : SendpulseInterface
    {
        ...
        public Sendpulse(string clientId, string clientSecret)
        {
            this.tokenName = md5(clientId + "::" + clientSecret);
    ...
    public string Base64Encode(string plainText)
        ...
        private bool GetToken()
        {
            ...
            data.Add("client_id", "cd69a300cfd35432e8338ae8bdf367bd");
            data.Add("client_secret", "c0a8628af92c9a5b7e65f80bfb615878");
        ...
        /// <returns></returns>
        public async Task<Dictionary<string, object>> SmtpSendMailAsync(Dictionary<string, object> emaildata)
        {
